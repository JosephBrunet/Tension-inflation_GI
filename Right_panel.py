...
#                    
#                    self.update_thread.emit()
#                    if self.P >= self.PV_target*1.025 and pump_interval == False:
#                        pump_interval = True
#                        
#                        self.signal_pump_run.emit(True)
#                        time.sleep(0.1)
...
#                        time.sleep(0.1)
#                        try:
#                            self.varFlowrate = float(Pump_seringe.getFlowRate())
#                        except:
#                            self.varFlowrate = 10
#                        time.sleep(0.05)
#                        if self.varFlowrate >= 10:
#                            Pump_seringe.setFlowRate(10)
#                        else:
#                            Pump_seringe.setFlowRate(self.varFlowrate)
#                        time.sleep(0.05)
#                        
#                        self.signal_pump_run.emit(False)
#                        time.sleep(0.05)
#                        
#                    elif self.P < self.PV_target*0.975:
#                        pump_interval = False
#                    
#                    
#                    
#                    if self.P < self.PV_target*1.025 and pump_interval == False and pump_running == False:
#                        self.signal_pump_run.emit(True)
#                        time.sleep(0.02)
#                        try:
#                            Pump_seringe.dose(80)
...
#                    self.signal_pump_run.emit(False)
#                except:
#                    print("Probleme remettre flowrate")
#                
...
class Right_panel(object):
    def setup_right_panel(self, parent=None):
        ...
        self.inibutton.setIcon(QIcon('image/button_start_push.png'))   #Change the button's icon by the image
...
#        self.input_pourc = QLineEdit()
#        self.input_pourc.setValidator(QDoubleValidator())
#        self.input_pourc.setMaxLength(2)
#        self.input_pourc.setAlignment(Qt.AlignRight)
#        self.input_pourc.setFont(QFont("Arial",12))
#        #input_vol_pressure.setCursor(QCursor(Qt.ArrowCursor))
#        self.input_pourc.setStyleSheet("QLineEdit{background: white;}")
#        
#        self.input_pourc.palette = QPalette()
#        self.input_pourc.palette.setColor(QPalette.Text, Qt.black)
#        self.input_pourc.setPalette(self.input_pourc.palette)
#        
#        
#        self.label_pourc = QLabel("Pourcent (%):", self)
#        self.label_pourc.setFont(QFont("Arial",12,QFont.Bold))
#        #self.lab.setGeometry(QRect(70, 80, 300, 300)) #(x, y, width, height)
#        
#        #Layout input label + input number
#        form_pourc = QFormLayout()     #Creation of the layout form
#        form_pourc.addRow(self.label_pourc, self.input_pourc)     #Add things in the layout
#        
#        #Add the button "Send" to the previous layout by putting all that in another layout
#        box_pourc_input = QHBoxLayout()
#        box_pourc_input.addLayout(form_pourc)
        ...
        box_preloading.addSpacing (5)
#        box_preloading.addWidget(sepTestV[5])
#        box_preloading.addSpacing (5)
#        box_preloading.addLayout(box_pourc_input)
#        box_preloading.addSpacing (5)       
...
#######################################################
        ...
        self.button_pause.setIcon(QIcon('image/button_pause.png'))
        ...
        self.button_restart.setIcon(QIcon('image/button_restart.png'))
...
#                
    ...
    def clickMethodPause(self):
        ...
        self.pause = True
        self.pump_run = False
        self.button_pause.setIcon(QIcon('image/button_pause_push.png'))
